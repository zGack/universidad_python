...
class ListaEnteraOrdenada(ListaEnteros, ListaOrdenada):
    pass
...
print(lista_enteros)
lista_enteros_ordenada = ListaEnteraOrdenada([7,3,4,1,-2])
# is instane
obj = lista_enteros
print('Es lista simple?', isinstance(obj, ListaSimple))
print('Es entero?', isinstance(obj, ListaEnteros))
print('Es ordenada?', isinstance(obj, ListaOrdenada))
print('Es entero ordenado?', isinstance(obj, ListaEnteraOrdenada))
